...
function updateHTML(selector, newValue){
	var elt = document.querySelector(selector);
	elt.innerHTML = newValue;
}

updateHTML(".stuff", "Hi Melissa!");
...
// document.querySelector('.disclosing-signature .disclosing-pary').innerHTML = disclosing;
query('.parties .disclosing-party').innerHTML = disclosing;
// query('.disclosing-signature .disclosing-party').innerHTML = disclosing;
updateHTML('.disclosing-party', disclosing);
